...
var container = document.getElementById( 'three-container1' );
...
function onDocumentMouseMove( event ) {
	...
	var objLeft = $("#three-container1").offset().left;
    var objTop = $("#three-container1").offset().top;

    var objCenterX = objLeft + $("#three-container1").width() / 2;
    var objCenterY = objTop + $("#three-container1").height() / 2;
